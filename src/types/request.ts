import { IMessage, IChat, IUser, IBasicResponse, IInlineKeyboardMarkup, IFile, IUpdate } from ".";
...
export interface RequestTypes {
    ...
    sendMessage: { 
        request: 
            { 
                ...
                entities?: MessageEventInit[], disable_web_page_preview?: boolean, disable_notification?: boolean,
    ...
    editMessageText: { 
        request: 
        {
            ...
            parse_mode?: ParseModes, entites?: MessageEventInit[], disable_web_page_preview?: boolean,
            reply_markup?: string 
        },
        response: IMessage 
    },
    ...
    copyMessage: {
        request: {
            chat_id: number | string | undefined, message_thread_id?: number, from_chat_id: string | number,
            message_id: number, caption?: string, parse_mode?: string, caption_entities?: MessageEventInit[],
